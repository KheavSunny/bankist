...
// const btnFeature = document.querySelectorAll('.nav__links a:nth-child(1)');
...
console.log(navLinks.querySelectorAll('.nav__item'));
console.log(navLinks.childNodes);
console.log(navLinks.children);
// navLinks.firstElementChild.style.color = 'blue';
navLinks.lastElementChild.style.backgroundColor = 'orange';
